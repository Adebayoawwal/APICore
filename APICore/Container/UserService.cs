...
namespace APICore.Container
{
    public class UserService : IUserService
    {
        ...
        public UserService(ApplicationDbcontext learndata, IMapper mapper, IEmailService emailService)
        {
       ...
       public async Task<APIResponse> ForgetPassword(string username)
        ...
        private async Task SendOtpMail(string useremail,string OtpText,string Name, string v)
        {
            ...
            await this.emailService.SendEmail(mailrequest, v);
        ...
        public Task<APIResponse> UserRegister(UserRegister userRegister)
        {
            throw new NotImplementedException();
        }

        Task<List<UserModel>> IUserService.Getall()
        {
            throw new NotImplementedException();
        }

        Task<UserModel> IUserService.Getbycode(string code)
        {
            throw new NotImplementedException();
        }

        Task<APIResponse> IUserService.UserRegisteration(UserRegister userRegister)
        {
            throw new NotImplementedException();
        }

        Task<APIResponse> IUserService.ConfirmRegister(int userid, string username, string otptext)
        {
            throw new NotImplementedException();
        }

        Task<APIResponse> IUserService.ResetPassword(string username, string oldpassword, string newpassword)
        {
            throw new NotImplementedException();
        }

        Task<APIResponse> IUserService.ForgetPassword(string username)
        {
            throw new NotImplementedException();
        }

        Task<APIResponse> IUserService.UpdatePassword(string username, string Password, string Otptext)
        {
            throw new NotImplementedException();
        }

        Task<APIResponse> IUserService.UpdateStatus(string username, bool userstatus)
        {
            throw new NotImplementedException();
        }

        Task<APIResponse> IUserService.UpdateRole(string username, string userrole)
        {
            throw new NotImplementedException();
        }
    }
