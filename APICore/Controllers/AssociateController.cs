...
namespace APICore.Controllers
{
    ...
    {
        private readonly ApplicationDbcontext learndata;
        public AssociateController(ApplicationDbcontext context) { 
        ...
        public async Task<ActionResult> getbycode(string code)
        {
            ...
            var data = await this.learndata.TblCustomers.FromSqlRaw(sqlquery, parameter).FirstOrDefaultAsync();
            if (data == null)
            {
                return NotFound();
            }
